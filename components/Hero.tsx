...
function Hero() {
  ...
  const urls: DocumentUrls = {
    es: "https://drive.google.com/file/d/1Ch9vA3RumKXHZkxUnrrZO8meAuot9Qkn/view?usp=sharing",
    en: "https://drive.google.com/file/d/1S0UirN6GqQ0MLdKl12FrkuzqPsZbU7A4/view?usp=sharing",
  };
