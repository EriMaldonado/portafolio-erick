...
function Hero() {
  ...
  const urls: DocumentUrls = {
    es: "https://drive.google.com/file/d/1kQsago2TCj1J8qM5aLKGuei59uOqIZ95/view?usp=sharing",
    en: "https://drive.google.com/file/d/1TD66RoMFpHa-EqRjCPOHqckMxI9ybWtz/view?usp=sharing",
  };
