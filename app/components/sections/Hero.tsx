...
function Hero() {
  ...
  const urls: DocumentUrls = {
    es: "https://drive.google.com/file/d/1Aid4facPjvFTCY2ExYCVKhBz0hNiieP6/view?usp=sharing",
    en: "https://drive.google.com/file/d/1w-VQt2MudfI9A4qxyL0sMz1EFx7qF41f/view?usp=sharing",
  };
